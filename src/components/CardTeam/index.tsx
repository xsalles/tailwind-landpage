...
export default function CardTeam({
  ...
  return (
    <div className="flex flex-col !p-[40px_35px] w-[387px] h-[331px] rounded-[45px] border-1 shadow-[0_5px_0_0_#191A23] gap-7">
      <div className="flex w-full justify-between place-items-end">
        <img src={photo} alt={`Foto do nosso parceiro de time ${name}`} />
        <div className="flex flex-col h-auto ">
          <h4 className="text-[20px] font-medium">{name}</h4>
          <p className="text-[18px]">{position}</p>
        </div>
        <a href="https://www.linkedin.com/in/pedro-sales-00090a274/" className="!mb-15">
          <img
